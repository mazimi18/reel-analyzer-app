# ===================================================================================
# FINAL v15.1 app.py - RECOMMENDED FOR PAID TIER (Corrected Order)
# This version uses the optimal "Single-Call" architecture and guarantees the
# correct Streamlit command order to prevent SetPageConfig errors.
# ===================================================================================
import os
import io
import re
